...
export const allRoutes = [
    ...
    new Route("/signin", "Connexion", "/pages/authentification/signin.html", "/js/auth/signin.js"),
    new Route("/signup", "Inscription", "/pages/authentification/signup.html", "/js/auth/signup.js"),
